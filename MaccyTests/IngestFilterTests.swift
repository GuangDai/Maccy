...
final class IngestFilterTests: XCTestCase {
  ...
  func testSharedTypeRulesContainTheExpectedUTIs() {
    XCTAssertEqual(
      IngestFilterRules.supportedTypes,
      [fileURLType, heicType, htmlType, jpegType, pngType, rtfType, stringType, tiffType]
    )
    XCTAssertEqual(
      IngestFilterRules.builtInIgnoredTypes,
      [transientType, autoGeneratedType, concealedType]
    )
  }
