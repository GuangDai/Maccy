...
| [`2026-07-11-xcodeproj-generation-m2-plan.md`](2026-07-11-xcodeproj-generation-m2-plan.md) | A | Completed M2 record: generated-target test plan/ID verifier, all five unit/UI/performance shards on the generated project, and warning-free Release package dry-run evidence. M3 owns production cutover. |
