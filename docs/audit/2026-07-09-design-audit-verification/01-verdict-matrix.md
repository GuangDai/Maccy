...
| DS-006 | ✅ `△over` | High→**Med** | High | E5 ongoing; History + AppState slices injected | Structural/testability only; History runtime globals are confined to composition (`29210900842`), and AppState instance copy/prewarm/observer paths no longer use global services (`ed664b2`, `29211587341`); other modules remain. |
