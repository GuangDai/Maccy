...
| DS-006 | ✅ `△over` | High→**Med** | High | E5 ongoing; History + AppState + Navigation slices injected | Structural/testability only; History runtime globals are confined to composition (`29210900842`), AppState instance copy/prewarm/observer paths no longer use global services (`ed664b2`, `29211587341`), and Navigation publishes lead changes through a constructor output instead of global Preview (`38ef0c9`, `29214579841`); other modules remain. |
