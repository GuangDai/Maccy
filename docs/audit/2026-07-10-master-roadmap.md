...
| E5 | Progressive DI vs `shared` | DS-006 | ongoing | M | History runtime effects are constructor-injected (`29210900842`); AppState copy/prewarm/observer instance paths no longer reach through globals (`ed664b2`, `29211587341`). Continue boundary-by-boundary; don't big-bang. |
