...
| E5 | Progressive DI vs `shared` | DS-006, DS-033 | ongoing | M | History runtime effects are injected (`29210900842`); AppState copy/prewarm/observer paths no longer reach through globals (`29211587341`); `StorageSettingsPane` receives its size reader from composition (`bd238fe`, `29212071043`). Continue boundary-by-boundary; don't big-bang. |
